...
export const postListByShopReducer = (state = { posts: [] }, action) => {
  switch (action.type) {
    case POST_LIST_BY_SHOP_REQUEST:
      return { loading: true, posts: [] }
    case POST_LIST_BY_SHOP_SUCCESS:
      return {
        loading: false,
        posts: action.payload.posts,
        pages: action.payload.pages,
...
export const postListByVendorReducer = (state = { posts: [] }, action) => {
  switch (action.type) {
    case POST_LIST_BY_VENDOR_REQUEST:
      return { loading: true, posts: [] }
    case POST_LIST_BY_VENDOR_SUCCESS:
      return {
        loading: false,
        posts: action.payload.posts,
        pages: action.payload.pages,
...
export const postListByCatReducer = (state = { posts: [] }, action) => {
  switch (action.type) {
    case POST_LIST_BY_CATEGORY_REQUEST:
      return { loading: true, posts: [] }
    case POST_LIST_BY_CATEGORY_SUCCESS:
      return {
        loading: false,
        posts: action.payload.posts,
        pages: action.payload.pages,
    ...
    case POST_LIST_BY_CATEGORY_FAIL:
      return { loading: false, error: action.payload }
    default:
      return state
  }
