...
export const POST_LIST_BY_SHOP_REQUEST = 'POST_LIST_BY_SHOP_REQUEST'
export const POST_LIST_BY_SHOP_SUCCESS = 'POST_LIST_BY_SHOP_SUCCESS'
export const POST_LIST_BY_SHOP_FAIL = 'POST_LIST_BY_SHOP_FAIL'

export const POST_LIST_BY_VENDOR_REQUEST = 'POST_LIST_BY_VENDOR_REQUEST'
export const POST_LIST_BY_VENDOR_SUCCESS = 'POST_LIST_BY_VENDOR_SUCCESS'
export const POST_LIST_BY_VENDOR_FAIL = 'POST_LIST_BY_VENDOR_FAIL'
