...
export const SHOP_BY_VENDOR_REQUEST = 'SHOP_BY_VENDOR_REQUEST'
export const SHOP_BY_VENDOR_SUCCESS = 'SHOP_BY_VENDOR_SUCCESS'
export const SHOP_BY_VENDOR_FAIL = 'SHOP_BY_VENDOR_FAIL'
